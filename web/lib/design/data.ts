  ...
  alerts: [
    {
      ...
      steps: [
        "Open the Letters page and generate a creditor notice for each known creditor. ProbatePilot fills in the estate details and the §9051 language for you.",
    ...
    },
    {
      ...
      whatYouNeed: [
        "The court-appointed Probate Referee for Alameda County (ProbatePilot can look this up)",
      ...
      steps: [
        ...
        "Once both assets show an appraised value, ProbatePilot assembles the DE-160 packet.",
    ...
    },
    {
      ...
      steps: [
        ...
        "If the estate earns more than $600 of income, you'll also need Form 1041, ProbatePilot will flag that separately.",
      ],
    },
  ],
  alertsNext: [
    {
      ...
      actionRequired: "Review the DE-160 packet ProbatePilot assembled and file it with the court.",
      whatYouNeed: [
      ...
      steps: [
        "Open the DE-160 packet ProbatePilot assembled from your documents and appraisals.",
